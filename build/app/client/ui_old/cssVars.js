...
exports.attachCssRootVars = exports.testId = exports.cssRootVars = exports.vars = exports.colors = void 0;
...
exports.vars = {
    ...
    fontFamilyData: new CustomProp('font-family-data', `Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol`),
    /* Font sizes */
...
const cssColors = values(exports.colors).map(v => v.decl()).join('\n');
const cssVars = values(exports.vars).map(v => v.decl()).join('\n');
const cssFontParams = `
  font-family: ${exports.vars.fontFamily};
  font-size: ${exports.vars.mediumFontSize};
...
`;
const cssVarsOnly = grainjs_1.styled('div', cssColors + cssVars);
const cssBodyVars = grainjs_1.styled('div', cssFontParams + cssColors + cssVars + cssBorderBox + cssInputFonts);
const cssBody = grainjs_1.styled('body', `
  margin: 0;
  height: 100%;
`);
const cssRoot = grainjs_1.styled('html', `
  height: 100%;
  overflow: hidden;
`);
exports.cssRootVars = cssBodyVars.className;
...
exports.testId = grainjs_1.makeTestId('test-');
/**
 * Attaches the global css properties to the document's root to them available in the page.
 */
function attachCssRootVars(productFlavor, varsOnly = false) {
    grainjs_1.dom.update(document.documentElement, varsOnly ? grainjs_1.dom.cls(cssVarsOnly.className) : grainjs_1.dom.cls(exports.cssRootVars));
    document.documentElement.classList.add(cssRoot.className);
    document.body.classList.add(cssBody.className);
}
exports.attachCssRootVars = attachCssRootVars;
